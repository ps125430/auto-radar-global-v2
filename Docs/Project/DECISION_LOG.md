...
| DEC-021 | 2026-07-01 | Real Ocean network access exists only inside Official Providers; Runtime consumes Snapshot v3 and Runtime purpose cannot use fixtures | Official data must be primary while Replay fixtures remain isolated | 小P / 小C | Pending Review |
